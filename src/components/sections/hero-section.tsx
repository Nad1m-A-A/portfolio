...
export function HeroSection() {
  return (
    <section className="relative min-h-svh pt-16">
      <div className="relative mx-auto w-full overflow-hidden bg-hero-surface">
        <div className="app_container grid min-h-[calc(100svh-4rem)] grid-cols-1 items-center gap-8 py-10 sm:gap-10 sm:py-14 md:gap-12 md:py-16 lg:grid-cols-2 lg:gap-16 lg:py-20">
          ...
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.24, duration: 0.8, ease: heroEase }}
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute top-full -left-24 size-100 bg-accent/20 blur-3xl" />
        </div>
      </div>
    </section>
  );
